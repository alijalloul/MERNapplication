      ...
      <div className="formContainer">
        ...
        <form>
          ...
          <div className="inputError">
            ...
            {formErrors.emailError ? <div className="error">{formErrors.emailError}</div> : formErrors.accountExists && <div className="error">{formErrors.accountExists}</div>}
          </div>
          ...
          <div className="inputError">
            <div className="passwordContainer">
              ...
              <button style={{ backgroundColor: "transparent", border: "none" }} onClick={handlePassVisible}>
                {passVisible ? <HideSVG /> : <ShowSVG />}
              </button>
            </div>
          ...
          <div className="signupinContainer">
            <button className="signupin" onClick={handleSubmit}>
